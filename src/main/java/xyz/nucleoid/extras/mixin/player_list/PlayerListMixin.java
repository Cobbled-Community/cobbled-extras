...
import xyz.nucleoid.extras.mixin.player_list.ClientboundPlayerInfoUpdatePacketAccessor;
...
public abstract class PlayerListMixin {
    ...
    private ClientboundPlayerInfoUpdatePacket extras$sendOthersToJoining(Collection<ServerPlayer> players, Connection connection, ServerPlayer target) {
        ...
        ((ClientboundPlayerInfoUpdatePacketAccessor) packet).setEntries(entries);
