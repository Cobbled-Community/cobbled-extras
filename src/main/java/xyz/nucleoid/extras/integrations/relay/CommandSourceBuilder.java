...
public interface CommandSourceBuilder {
    ...
    CommandSourceStack buildCommandSource(CommandSource output, MinecraftServer server, String name, PermissionSet permissionLevel, List<String> roles);
    ...
    final class Vanilla implements CommandSourceBuilder {
        ...
        @Override
        public CommandSourceStack buildCommandSource(CommandSource output, MinecraftServer server, String name, PermissionSet permissionLevel, List<String> roles) {
